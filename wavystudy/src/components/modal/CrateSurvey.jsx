...
export default function CreateSurveyModal({
    ...
    async function CreateSurveyHandle(e) {
        ...
        try {
			...
			.addString(d.toString())
			.addString(image.value)
			.addUint256( (Number(reward.value) * 1e8));

            await sendTransaction( "CreateSurvey",params,(Number(reward.value) ));
            ...
            <Modal.Body className="show-grid">
                <Form onSubmit={CreateSurveyHandle}>
                    ...
                    <Form.Group className="mb-3 grid" controlId="formGroupName">
                        ...
                        <input required name="reward" placeholder="Reward" id="reward" type='number' step={"0.0001"} className="w-40 border rounded pt-2 pb-2 border-gray-400 pl-4 pr-4" />
                       
                    </Form.Group>
                    <div className="d-grid">
                        <Button name="surveyBTN" type='submit' style={{ 'display': 'flex' }} className='w-[128px] h-12 flex justify-center items-center'  >
