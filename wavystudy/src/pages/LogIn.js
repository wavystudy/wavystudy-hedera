	...
	return (
		<div className="min-h-screen grid-cols-2 flex">
			<div className="bg-blue-200 flex-1 img-panel">
				<img src={require("../assets/login-picture.png")} className="h-full w-full object-cover object-center" alt="WavyStudy Logo" />
			</div>
			<div className="bg-white flex-1 flex flex-col justify-center items-center">
				<div className="pl-20 pr-20 relative container-panel">
					...
					<p className="mt-3">Personalized clinical trial experience for better outcomes.</p>
					...
					<div className="mt-10">
						...
						{connected ? (
							<>
								<button
									onClick={LoginClick}
									className={`bg-[#36C499] text-black rounded-md shadow-md h-10 w-full mt-3 hover:bg-[#2FAE88] transition-colors overflow:hidden flex content-center items-center justify-center cursor-pointer`}
								>
						...
						<button onClick={registerLink} className=" text-gray-500 rounded-md shadow-md h-10 w-full mt-3 hover:bg-black transition-colors">
							Register
						</button>
