...
String domain = "https://wavystudy-hedera-api.vercel.app";
  String userid = "";
  String AccountTokenAddress = "";
  bool hasDevice = false;
  var allDevices = "";
  List<ChartData> chartDataBlood = [
    ChartData("11/11/2025", 23),
    ChartData("12/11/2025", 55),
    ChartData("13/11/2025", 76),
    ChartData("14/11/2025", 33),
    ChartData("15/11/2025", 55),
    ChartData("16/11/2025", 99),
    ChartData("17/11/2025", 88),
    ChartData("18/11/2025", 87)
  ];
  List<ChartData> chartDataSleep = [
    ChartData("11/11/2025", 445),
    ChartData("12/11/2025", 656),
    ChartData("13/11/2025", 443),
    ChartData("14/11/2025", 787),
    ChartData("15/11/2025", 834),
    ChartData("16/11/2025", 590),
    ChartData("17/11/2025", 776),
    ChartData("18/11/2025", 589)
  ];
  List<ChartData> chartDataCalories = [
    ChartData("11/11/2025", 67),
    ChartData("12/11/2025", 78),
    ChartData("13/11/2025", 89),
    ChartData("14/11/2025", 98),
    ChartData("15/11/2025", 78),
    ChartData("16/11/2025", 90),
    ChartData("17/11/2025", 78),
    ChartData("18/11/2025", 89)
  ];
  List<ChartData> chartDataSteps = [
    ChartData("11/11/2025", 76),
    ChartData("12/11/2025", 54),
    ChartData("13/11/2025", 34),
    ChartData("14/11/2025", 90),
    ChartData("15/11/2025", 67),
    ChartData("16/11/2025", 54),
    ChartData("17/11/2025", 67),
    ChartData("18/11/2025", 45)
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          toolbarHeight: 80,
          backgroundColor: Color(0xFF36C499),
          title: Container(
              height: 80,
              child: Row(
