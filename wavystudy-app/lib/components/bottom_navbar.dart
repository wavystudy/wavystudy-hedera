...
class WavystudyNavbar extends ConsumerStatefulWidget {
  final void Function(int)? OnTap;
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _WavystudyNavbarState();
      WavystudyNavbar(this.OnTap);
}

class _WavystudyNavbarState extends ConsumerState<WavystudyNavbar> {
  @override
  Widget build(BuildContext context) {
    ...
    return BottomNavigationBar(
      ...
      selectedItemColor: Color(0xFF36C499),
